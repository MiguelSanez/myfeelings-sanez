package sanez.miguel.myfeelings
...
import sanez.miguel.myfeelings.utilities.CustomBarDrawable
import sanez.miguel.myfeelings.utilities.CustomCircleDrawable
import sanez.miguel.myfeelings.utilities.Emociones
import sanez.miguel.myfeelings.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(!data){
            ...
            graphVeryHappy.background = CustomBarDrawable(this,
                Emociones("Muy feliz",0.0f,R.color.mustard,veryHappy)
            )
            graphHappy.background = CustomBarDrawable(this,
                Emociones("Feliz",0.0f,R.color.orange,happy)
            )
            graphNeutral.background = CustomBarDrawable(this,
                Emociones("Neutral",0.0f,R.color.greenie,neutral)
            )
            graphSad.background = CustomBarDrawable(this, Emociones("Triste",0.0f,R.color.blue,sad))
            graphVerySad.background = CustomBarDrawable(this,
